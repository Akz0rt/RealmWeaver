...
namespace WorldGen.Generation.Mountains
{
    ...
    public static class MountainInk
    {
        ...
        /// <summary>Потолок меток на одну гору. Он есть, и молчать о нём нельзя: MarkCount выдаёт
        /// наружу признак «упёрлись», а слой говорит об этом вслух. Тихая обрезка читается как
        /// «нарисовано всё», а нарисовано не всё.</summary>
        public const int GritCap = 600;
