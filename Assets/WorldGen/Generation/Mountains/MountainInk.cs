...
namespace WorldGen.Generation.Mountains
{
    ...
    public static class MountainInk
    {
        ...
        ///
        /// Доля радиуса, а не пиксели: мелкие и крупные горы обязаны выглядеть одинаково. Число
        /// выведено из площади метки в браузерном превью (прямоугольник sz×0.7sz, sz от 0.9 до 2.6
        /// при радиусе 10) — треугольник той же ширины кроет вдвое меньше, и первая редакция
        /// переноса вышла вдвое светлее оригинала.
        /// </summary>
        public static float MarkSize(float radius, float u)
        {
            if (u < 0f) u = 0f; else if (u > 1f) u = 1f;
            return 0.14f * radius * (0.6f + u);
        }
