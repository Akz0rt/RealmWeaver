...
namespace WorldGen.Generation.Mountains
{
    ...
    public sealed class MountainBlob
    {
        ...
        // Зерна у пятна больше НЕТ. Оно бралось от самого старого мазка и держало уже нарисованное
        // на месте при дорисовке; с разворотом 2026-08-14 источником стал рельеф, у массива из
        // клеток «самого старого» не бывает, и зерно переехало к самой оси — см.
        // MountainGeometry.AxisSeed, там же честно записано, что именно оно теперь гарантирует.

        /// <summary>FNV-1a от целого — тем же способом проект уже сеет внутренности зданий.</summary>
