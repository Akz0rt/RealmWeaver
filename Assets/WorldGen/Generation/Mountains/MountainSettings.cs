...
namespace WorldGen.Generation.Mountains
{
    ...
    public sealed class MountainSettings
    {
        ...
        /// <summary>
        /// Показатель склона (§10). Больше единицы — склон ВОГНУТЫЙ: пологий у подножия, самый
        /// крутой у гребня, два склона сходятся в остриё. Это взгляд СБОКУ. Единица — прямой
        /// треугольник. Меньше единицы — склон выпуклый, макушка тупая: так гора читается, когда
        /// смотришь на неё немного СВЕРХУ.
        /// </summary>
        public float SlopeExponent = 1.6f;
