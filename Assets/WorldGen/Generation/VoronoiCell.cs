...
namespace WorldGen.Generation
{
    ...
    public class VoronoiCell
    {
        ...
        /// <summary>
        /// Id региона (политической области), к которому принадлежит клетка. -1 = не назначено
        /// (регионы больше не генерируются автоматически - свежий мир оставляет каждую клетку
        /// с RegionId == -1). Регионы теперь создаются и назначаются вручную пользователем -
        /// см. RegionManager (WorldGen.Rendering) для метаданных региона (имя/цвет).
        /// </summary>
