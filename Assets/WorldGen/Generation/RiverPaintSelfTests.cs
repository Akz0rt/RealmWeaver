...
namespace WorldGen.Generation
{
    ...
    public class RiverPaintSelfTests : MonoBehaviour
    {
        ...
        public void SelfTestMaskUnion()
        {
            ...
            // Ширина: полуширина 3, поэтому пиксель в 2,5 от оси — вода, а в 4 — уже суша.
            if (!both[52 * w + 20])
            { Debug.LogError("FAIL mask: у кромки русла (2,5 от оси при полуширине 3) сухо — река уже, чем задано"); ok = false; }
            if (both[54 * w + 20])
