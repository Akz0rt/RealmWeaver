...
namespace WorldGen.Generation
{
    ...
    public class RiverPaintSelfTests : MonoBehaviour
    {
        ...
        /// накопленным по своей альфе. Без этого «перекрытия не видно» проверить нечем.
        ///
        /// Цвет треугольника берётся с ПЕРВОЙ его вершины — то есть годится только там, где он по
        /// треугольнику постоянен, а это все реки без устья (MouthLength == 0). Добавите в заготовку
        /// устье — сначала научите это интерполировать, иначе проверка тихо соврёт.</summary>
