...
namespace WorldGen.PlayerPrep.Data
{
    ...
    public class ClassDef
    {
        ...
        ///
        /// Список сужает ВЛАДЕНИЕ, а не список навыков класса: годным считается навык, которым
        /// персонаж владеет, — хоть от класса, хоть от предыстории (SheetMath.ExpertiseEligibleIds).
        /// Волшебник с предысторией «Мудрец» ставит компетентность на её Магию и Историю, потому что
        /// обе названы здесь, и не ставит на Проницательность, потому что её здесь нет.
        ///
        /// Каждый идентификатор обязан лежать и в SkillChoices — это стережёт RulesIntegrity, и
        /// стережёт как ОПЕЧАТКУ: см. CheckClassExpertiseChoices, там же сказано, почему правило
        /// шире необходимого и чей это вопрос.</summary>
