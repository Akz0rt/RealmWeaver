...
namespace WorldGen.PlayerPrep.Data
{
    ...
    public static class LevelChoiceOps
    {
        ...
        /// выбирал игрок. Речь именно о НАДКУСАННОЙ прибавке: характеристику, уже стоящую на
        /// двадцати, панель выбрать не даёт вовсе (кнопка гаснет), так что записывать там нечего.
        ///
