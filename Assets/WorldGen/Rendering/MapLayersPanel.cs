...
namespace WorldGen.Rendering
{
    ...
    public class MapLayersPanel : MonoBehaviour
    {
        ...
        void BuildUI()
        {
            ...
            // MenuBarInset (WorkspaceBuilder.cs:262) before any pane exists, AND ContentArea is the second
            // child of the pane's VerticalLayoutGroup, under TabStripView (WorkspaceBuilder.BuildPane, :458).
